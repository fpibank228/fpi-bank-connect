...
const Leaderboard = () => {
  // Моковые данные для топ-10 пользователей
  const topUsers = [
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold text-green-500">{currentUser.tokens.toLocaleString()}</p>
          </CardContent>
        </Card>
      </div>
          ...
          <Table>
            ...
            <TableBody>
              {topUsers.map((user, index) => (
                <TableRow key={user.username} className={user.username === currentUser.username ? "bg-muted" : ""}>
